...
<%
	Integer current_id = (Integer)session.getAttribute("id");
	BlogController blogController = new BlogController();
	List<Blog_post> blogs = blogController.getMyBlog(current_id);
	blogs = blogController.getMyBlog(current_id);
%>
	...
	<div class="container-custom">
		<div class="navbar-content">
			...
			<div>
				...
				<div class="btn btn-success"><a href="myBlog.jsp">View my Blog</a></div>
